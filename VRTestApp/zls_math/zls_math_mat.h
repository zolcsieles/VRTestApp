...
namespace zls
{
	namespace math
	{
		...
		public:
			...
			void SetView(const Vec3<T>& eyePos, const Vec3<T>& upDir, const Vec3<T>& viewDir)
			{
				Vec3<T> zDir = viewDir.normal();
			...
			Mat4 operator*(Mat4& o)
			{
				Mat4& t = *this;
				return Mat4(
					t(0,0) * o(0,0) + t(1,0) * o(0,1) + t(2,0) * o(0,2) + t(3,0) * o(0,3),
					t(0,0) * o(1,0) + t(1,0) * o(1,1) + t(2,0) * o(1,2) + t(3,0) * o(1,3),
					t(0,0) * o(2,0) + t(1,0) * o(2,1) + t(2,0) * o(2,2) + t(3,0) * o(2,3),
					t(0,0) * o(3,0) + t(1,0) * o(3,1) + t(2,0) * o(3,2) + t(3,0) * o(3,3),
					
					t(0,1) * o(0,0) + t(1,1) * o(0,1) + t(2,1) * o(0,2) + t(3,1) * o(0,3),
					t(0,1) * o(1,0) + t(1,1) * o(1,1) + t(2,1) * o(1,2) + t(3,1) * o(1,3),
					t(0,1) * o(2,0) + t(1,1) * o(2,1) + t(2,1) * o(2,2) + t(3,1) * o(2,3),
					t(0,1) * o(3,0) + t(1,1) * o(3,1) + t(2,1) * o(3,2) + t(3,1) * o(3,3),
					
					t(0,2) * o(0,0) + t(1,2) * o(0,1) + t(2,2) * o(0,2) + t(3,2) * o(0,3),
					t(0,2) * o(1,0) + t(1,2) * o(1,1) + t(2,2) * o(1,2) + t(3,2) * o(1,3),
					t(0,2) * o(2,0) + t(1,2) * o(2,1) + t(2,2) * o(2,2) + t(3,2) * o(2,3),
					t(0,2) * o(3,0) + t(1,2) * o(3,1) + t(2,2) * o(3,2) + t(3,2) * o(3,3),
					
					t(0,3) * o(0,0) + t(1,3) * o(0,1) + t(2,3) * o(0,2) + t(3,3) * o(0,3),
					t(0,3) * o(1,0) + t(1,3) * o(1,1) + t(2,3) * o(1,2) + t(3,3) * o(1,3),
					t(0,3) * o(2,0) + t(1,3) * o(2,1) + t(2,3) * o(2,2) + t(3,3) * o(2,3),
					t(0,3) * o(3,0) + t(1,3) * o(3,1) + t(2,3) * o(3,2) + t(3,3) * o(3,3)
					);
			}
		};
